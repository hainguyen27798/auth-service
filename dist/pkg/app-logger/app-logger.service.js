...
}), winston_1.format.simple(), someColoredFormat);
const fileFormat = winston_1.format.combine(winston_1.format.errors({ stack: true }), winston_1.format.timestamp({
    format: 'YYYY-MM-DD HH:mm:ss',
}), winston_1.format.json(), winston_1.format.printf((payload) => {
